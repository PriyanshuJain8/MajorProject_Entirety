                          ...
                          <Tab.Pane eventKey="ltn_tab_1_3">
                              ...
                              <Row>
                                <div className="col-md-6 col-12 learts-mb-30">
                                  ...
                                  <address>
                                    <p>
                                      <strong>Priyanshu Jain</strong>
                                    </p>
                                    <p>
                                       Castleboy, Dublin Road,  <br />
                                        Athlone, Ireland
                                    </p>
                                    <p>Mobile: +353 892081662</p>
                                  </address>
                                </div>
                                <div className="col-md-6 col-12 learts-mb-30">
                                  <h4>
                                  ...
                                  <address>
                                    ...
                                    <p>Mobile: Same as the Billing Mobile</p>
                                  </address>
                                </div>
                              </Row>
                                  ...
                                  <div className="row mb-50">
                                    ...
                                    <Col xs={12} md={6}>
                                      ...
                                      <input
                                        type="email"
                                        name="ltn__lastname"
                                        placeholder="Priyanshujain0802@gmail.com"
                                      />
                                    </Col>
                                  </div>
                                  <fieldset>
